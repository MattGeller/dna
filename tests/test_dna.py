...
class TestDNA(TestCase):
    ...
    def test_reading_the_database(self):
        database = populate_database('../database/small.csv')
        expectation = {
            'AGATC': {
                2: ['Alice'],
                4: ['Bob'],
